<script lang="ts">
	import { Icon, Item, List, ListHeader, RangeSlider } from '@svonic/core';
	import { brush, contrast, sunny, thermometer } from 'ionicons/icons/index.js';
...
<List>
	<ListHeader>Adjust Display</ListHeader>
