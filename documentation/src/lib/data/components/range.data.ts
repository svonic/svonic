...
export const RangeData: ComponentDataAPI = {
	description: {
		en: `The Range lets users select from a range of values by moving the slider knob. It can accept dual knobs, but by default one knob controls the value of the range.`
	},
	dispatchedEventList: [
		{ ...blur },
		{ ...change },
