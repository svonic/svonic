...
export const DatetimeData: ComponentDataAPI = {
	description: {
		en: `The Datetime presents a calendar interface and time wheel, making it easy for users to select dates and times. Datetimes are similar to the native input elements of datetime-local, however, the Datetime component makes it easy to display the date and time in the preferred format, and manage the datetime values.`
	},
	dispatchedEventList: [
		{ ...blur },
		{
	...
	methodList: [
		{
			description: {
				en: `Emits the ionCancel event and optionally closes the popover or modal that the datetime was presented in.`
			},
			name: 'cancel',
	...
	propList: [
		...
		{ ...name },
		{
			...
			AM/PM. 'date-time' will show the datetime first and time picker second.
			'time-date' will show the time picker first and datetime second.`
			},
			hasDemo: false,
			isSpecial: false,
			name: 'presentation',
