...
export const SpinnerData: ComponentDataAPI = {
	description: {
		en: `The Spinner component provides a variety of animated SVG spinners. Spinners are visual indicators that the app is loading content or performing another process that the user needs to wait on.
	...
	forwardedEventList: [],
	ionic: {
		documentationUrl: 'https://ionicframework.com/docs/api/spinner',
		sourceUrl: 'https://github.com/ionic-team/ionic-framework/tree/main/core/src/components/spinner'
	},
